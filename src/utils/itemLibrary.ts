...
const ITEM_LIBRARY: ItemBase[] = [
  ...
  { name: 'Serrated Blade',        equipSlot: 'mainHand', rarity: 'uncommon', description: 'Jagged teeth catch armour and rend flesh.',                       stats: { damage: 6, critChance: 0.04 } },
  ...
  { name: "Assassin's Kris",       equipSlot: 'mainHand', rarity: 'rare',     description: 'Wavy-bladed ritual dagger that finds every gap in armour.',       stats: { damage: 5, attackSpeed: 0.25, critChance: 0.07 } },
  { name: 'Blood-soaked Cleaver',  equipSlot: 'mainHand', rarity: 'rare',     description: 'The blade has tasted so much blood it practically heals itself.', stats: { damage: 9, lifesteal: 3 } },
  { name: 'Void Blade',            equipSlot: 'mainHand', rarity: 'epic',     description: 'A cursed edge that hungers for more.',                            stats: { damage: 14, lifesteal: 4, critChance: 0.05 } },
  ...
  { name: 'Tower Shield of the Bear',equipSlot:'offHand', rarity: 'rare',     description: 'Massive. Every hit that lands feels like it hit a wall.',          stats: { hp: 30, damageReduction: 2 } },
  ...
  { name: 'Aegis of the Ancients', equipSlot: 'offHand',  rarity: 'epic',     description: 'An artifact buckler older than the kingdom, still unbroken.',      stats: { hp: 40, damageReduction: 3, lifesteal: 2 } },
  ...
  { name: 'Shadow Hood',           equipSlot: 'head',     rarity: 'rare',     description: 'Silk-dark hood that blurs your outline and steadies your hand.',    stats: { critChance: 0.04, dodgeChance: 0.06 } },
  { name: 'Crown of the Warlord',  equipSlot: 'head',     rarity: 'epic',     description: 'A conqueror\'s crown — wearing it makes enemies hesitate.',        stats: { damage: 6, lifesteal: 3 } },
  ...
  { name: 'Shadow Garb',           equipSlot: 'chest',    rarity: 'rare',     description: 'Slim dark armour that lets you slip through gaps in an attack.',   stats: { critChance: 0.03, dodgeChance: 0.08 } },
  { name: 'Plate of Vitality',     equipSlot: 'chest',    rarity: 'rare',     description: 'Thick iron plates riveted over a chain base.',                     stats: { hp: 35, damageReduction: 2 } },
  { name: 'Dragonscale Chestplate',equipSlot: 'chest',    rarity: 'epic',     description: 'Scales pried from a slain wyvern — still radiating warmth.',       stats: { hp: 25, damageReduction: 3, critChance: 0.03 } },
  ...
  { name: 'Eye of the Void',       equipSlot: 'amulet',   rarity: 'epic',     description: 'A gem that stares back — and teaches you to strike first.',         stats: { critChance: 0.06, lifesteal: 3, damage: 4 } },
  ...
  { name: 'Ring of the Predator',  equipSlot: 'ring1',    rarity: 'rare',     description: 'Set with a fang — your strikes feel predatory.',                     stats: { critChance: 0.05, damage: 3 } },
  ...
  { name: 'Serpent Ring',          equipSlot: 'ring2',    rarity: 'rare',     description: 'A coiled serpent whose fangs bite the wearer\'s foe.',               stats: { critChance: 0.04, damage: 4 } },
  { name: 'Void Ring',             equipSlot: 'ring2',    rarity: 'epic',     description: 'Stares back at you when you look into its gem.',                     stats: { lifesteal: 3, critChance: 0.04, damage: 5 } },
