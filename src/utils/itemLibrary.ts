...
const ITEM_LIBRARY: ItemBase[] = [
  ...
  { name: 'Serrated Blade',        equipSlot: 'mainHand', rarity: 'uncommon', description: 'Jagged teeth catch armour and rend flesh.',                       stats: { damage: 6, critChance: 10 } },
  ...
  { name: "Assassin's Kris",       equipSlot: 'mainHand', rarity: 'rare',     description: 'Wavy-bladed ritual dagger that finds every gap in armour.',       stats: { damage: 5, attackSpeed: 0.25, critChance: 18 } },
  ...
  { name: 'Void Blade',            equipSlot: 'mainHand', rarity: 'epic',     description: 'A cursed edge that hungers for more.',                            stats: { damage: 14, lifesteal: 8, critChance: 12 } },
  ...
  { name: "Duelist's Parry Dagger",equipSlot: 'offHand',  rarity: 'uncommon', description: 'A nimble blade held reversed — perfect for deflecting blows.',    stats: { dodgeChance: 8 } },
  ...
  { name: 'Bladed Gauntlet',       equipSlot: 'offHand',  rarity: 'rare',     description: 'Armoured fist lined with forward-facing spikes.',                  stats: { damage: 4, dodgeChance: 8 } },
  ...
  { name: "Hunter's Cowl",         equipSlot: 'head',     rarity: 'uncommon', description: 'Light hood favoured by rangers for moving unseen.',                stats: { dodgeChance: 6 } },
  { name: 'Shadow Hood',           equipSlot: 'head',     rarity: 'rare',     description: 'Silk-dark hood that blurs your outline and steadies your hand.',    stats: { critChance: 10, dodgeChance: 6 } },
  ...
  { name: 'Shadow Garb',           equipSlot: 'chest',    rarity: 'rare',     description: 'Slim dark armour that lets you slip through gaps in an attack.',   stats: { critChance: 8, dodgeChance: 8 } },
  ...
  { name: 'Dragonscale Chestplate',equipSlot: 'chest',    rarity: 'epic',     description: 'Scales pried from a slain wyvern — still radiating warmth.',       stats: { hp: 25, damageReduction: 5, critChance: 8 } },

  // ── legs ────────────────────────────────────────────────────────────────────
  { name: 'Leather Greaves',       equipSlot: 'legs',     rarity: 'common',   description: 'Worn leather guards that still do the job.',                        stats: { hp: 8 } },
  { name: 'Windrunner Boots',      equipSlot: 'legs',     rarity: 'uncommon', description: 'Swift-soled boots enchanted for evasion.',                          stats: { dodgeChance: 8 } },
  ...
  { name: 'Phantom Treads',        equipSlot: 'legs',     rarity: 'epic',     description: 'You move before your mind finishes thinking.',                      stats: { dodgeChance: 12, critChance: 8 } },
  ...
  { name: 'Amulet of the Swift',   equipSlot: 'amulet',   rarity: 'rare',     description: 'Cool jade carved into a serpent devouring its tail.',               stats: { attackSpeed: 0.2, dodgeChance: 6 } },
  { name: 'Eye of the Void',       equipSlot: 'amulet',   rarity: 'epic',     description: 'A gem that stares back — and teaches you to strike first.',         stats: { critChance: 15, lifesteal: 6, damage: 4 } },
  ...
  { name: 'Ring of the Predator',  equipSlot: 'ring1',    rarity: 'rare',     description: 'Set with a fang — your strikes feel predatory.',                     stats: { critChance: 12, damage: 3 } },
  { name: 'Ouroboros Ring',        equipSlot: 'ring1',    rarity: 'epic',     description: 'A serpent swallowing its tail — you take, and it gives back.',       stats: { lifesteal: 8, critChance: 8, attackSpeed: 0.1 } },
  ...
  { name: 'Serpent Ring',          equipSlot: 'ring2',    rarity: 'rare',     description: 'A coiled serpent whose fangs bite the wearer\'s foe.',               stats: { critChance: 10, damage: 4 } },
  { name: 'Void Ring',             equipSlot: 'ring2',    rarity: 'epic',     description: 'Stares back at you when you look into its gem.',                     stats: { lifesteal: 6, critChance: 10, damage: 5 } },
