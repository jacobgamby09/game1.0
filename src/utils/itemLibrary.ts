...
const ITEM_LIBRARY: ItemBase[] = [
  ...
  // ── ring2 ───────────────────────────────────────────────────────────────────
  { name: 'Silver Ring',           equipSlot: 'ring2',    rarity: 'common',   icon: Circle,   description: 'A light silver ring that makes your hands feel swifter.',            stats: { attackSpeed: 0.05 } },
  { name: 'Iron Signet',           equipSlot: 'ring2',    rarity: 'uncommon', icon: Gem,      description: 'A military signet stamped with a crossed-swords crest.',             stats: { damage: 2, attackSpeed: 0.10 } },
  { name: 'Serpent Ring',          equipSlot: 'ring2',    rarity: 'rare',     icon: Circle,   description: 'A coiled serpent whose fangs bite the wearer\'s foe.',               stats: { critChance: 0.04, damage: 3 } },
  { name: 'Void Ring',             equipSlot: 'ring2',    rarity: 'epic',     icon: Eye,      description: 'Stares back at you when you look into its gem.',                     stats: { lifesteal: 3, critChance: 0.04, damage: 3 } },

  // ── spell ───────────────────────────────────────────────────────────────────
  { name: 'Flame Scroll',          equipSlot: 'spell',    rarity: 'common',   icon: Flame,    description: 'A tattered scroll pulsing with heat.',           stats: { damage: 1 }, ability: { name: 'Fireball',         description: 'Deals 25 damage.',  cooldown: 12000, effectType: 'damageEnemy', value: 25 } },
  { name: 'Frost Tome',            equipSlot: 'spell',    rarity: 'rare',     icon: Snowflake,description: 'Pages inscribed in permafrost runes.',           stats: { damage: 3 }, ability: { name: 'Ice Lance',         description: 'Deals 30 damage.',  cooldown: 10000, effectType: 'damageEnemy', value: 30 } },
  { name: 'Thunder Codex',         equipSlot: 'spell',    rarity: 'epic',     icon: Zap,      description: 'Lightning trapped between two pages.',           stats: { damage: 5 }, ability: { name: 'Lightning Strike',  description: 'Deals 50 damage.',  cooldown: 15000, effectType: 'damageEnemy', value: 50 } },
  { name: 'Arcane Grimoire',       equipSlot: 'spell',    rarity: 'uncommon', icon: Sparkles, description: 'A scholar\'s notebook rewritten with power.',    stats: { hp: 5 },    ability: { name: 'Arcane Bolt',       description: 'Deals 20 damage.',  cooldown:  8000, effectType: 'damageEnemy', value: 20 } },
