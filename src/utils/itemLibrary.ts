...
const ITEM_LIBRARY: ItemBase[] = [
  ...
  { name: 'Thunderous Warhammer',  equipSlot: 'mainHand', rarity: 'epic',     description: 'Hits like a siege weapon — and swings about as fast.',            stats: { damage: 15, attackSpeed: -0.3 } },
  ...
  { name: "Duelist's Parry Dagger",equipSlot: 'offHand',  rarity: 'uncommon', description: 'A nimble blade held reversed — perfect for deflecting blows.',    stats: { dodgeChance: 0.05 } },
  ...
  { name: 'Crown of the Warlord',  equipSlot: 'head',     rarity: 'epic',     description: 'A conqueror\'s crown — wearing it makes enemies hesitate.',        stats: { damage: 4, lifesteal: 3 } },
  ...
  { name: 'Shadow Garb',           equipSlot: 'chest',    rarity: 'rare',     description: 'Slim dark armour that lets you slip through gaps in an attack.',   stats: { critChance: 0.03, dodgeChance: 0.05 } },
  { name: 'Plate of Vitality',     equipSlot: 'chest',    rarity: 'rare',     description: 'Thick iron plates riveted over a chain base.',                     stats: { hp: 20, damageReduction: 2 } },
  { name: 'Dragonscale Chestplate',equipSlot: 'chest',    rarity: 'epic',     description: 'Scales pried from a slain wyvern — still radiating warmth.',       stats: { hp: 15, damageReduction: 3, critChance: 0.03 } },

  // ── legs ────────────────────────────────────────────────────────────────────
  { name: 'Leather Greaves',       equipSlot: 'legs',     rarity: 'common',   description: 'Worn leather guards that still do the job.',                        stats: { hp: 8 } },
  { name: 'Windrunner Boots',      equipSlot: 'legs',     rarity: 'uncommon', description: 'Swift-soled boots enchanted for evasion.',                          stats: { dodgeChance: 0.05 } },
  { name: 'Ironclad Legguards',    equipSlot: 'legs',     rarity: 'rare',     description: 'Solid iron plates welded to a chain base.',                         stats: { hp: 12, damageReduction: 2 } },
  { name: 'Phantom Treads',        equipSlot: 'legs',     rarity: 'epic',     description: 'You move before your mind finishes thinking.',                      stats: { dodgeChance: 0.08, critChance: 0.03 } },
